...
@section('content')
<form action="{{ route('users.update', $users['id']) }}" method="POST" class="card p-5" style="margin-left: 240px; width: 70%; ">
    @csrf
    @method('PATCH')
    ...
    <div class="mb-3 row">
        <label for="password" class="col-sm-2 col-form-label text-end">Ubah Password:</label>
        <div class="col-sm-10">
